...
namespace AbpAdmin
{
    [DependsOn(
        ...
        typeof(AbpAdminWebModule),
        typeof(AbpAdminApplicationTestModule)
    )]
    public class AbpAdminWebTestModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<IMvcBuilder>(builder =>
            {
                builder.PartManager.ApplicationParts.Add(new AssemblyPart(typeof(AbpAdminWebModule).Assembly));
            });
        }
